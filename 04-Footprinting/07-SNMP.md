...
## Real Lab Output
```
HackerpatelOO7_1@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128 | tee SNMPWalk.txt
...
HackerpatelOO7_1@htb[/htb]$ grep -m 1 -B 8 "HTB{" SNMPWalk.txt
iso.3.6.1.2.1.25.1.7.1.2.1.2.4.70.76.65.71 = STRING: "/usr/share/flag.sh"
iso.3.6.1.2.1.25.1.7.1.3.1.1.4.70.76.65.71 = STRING: "HTB{...flag_redacted...}"
```
